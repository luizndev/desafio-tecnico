...
import { handleLogin } from '@/lib/form'
  ...
  return (
    <div className='px-7 flex flex-col h-screen items-center justify-center'>
        ...
        <div className='w-full max-w-md flex flex-col gap-4  shadow-2xl rounded-lg p-6'>
            ...
            <div>
                <span className='text-gray-600 text-[14px]'>Preencha para acessar</span>
                <h1 className='text-xl  text-[#030712] font-bold'>Lista de Tarefas Compartilhada</h1>
            </div>
            ...
            <span>Você não possui uma conta? <span className='font-semibold cursor-pointer' onClick={() => window.location.href = "/register"}>Clique aqui</span></span>
